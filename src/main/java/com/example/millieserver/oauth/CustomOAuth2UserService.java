...
import com.example.millieserver.member.Member;
import com.example.millieserver.member.MemberService;
...
//                Collections.singleton(new SimpleGrantedAuthority("ROLE_".concat(findMember.get().getRole().toString()))),
